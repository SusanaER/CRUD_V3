...
namespace RegularClientSupermarket
{
    public class Startup
    {
        ...
        {
            string connectionString = "server=localhost;port=3306;database=regularclientsupermarket;user=root;password=root;CharSet=utf8;Sslmode=none;Pooling=false;AllowPublicKeyRetrieval=True";
